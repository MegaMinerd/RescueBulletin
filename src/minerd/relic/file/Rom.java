...
public abstract class Rom {
	...
	public abstract SbinFile getMonsterSbin() throws IOException;
	
	public abstract SbinFile getEffectSbin() throws IOException;
	
	public abstract SbinFile getOrnamentSbin() throws IOException;
